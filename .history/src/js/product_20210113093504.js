        ...
        cont = `
            ...
            <div class="pro_content fright">
                ...
                <div class="pro_selected">
                    <p class="clearfix">
                        ${title}&nbsp;${defaultItem.versions}&nbsp;${defaultItem.color}
                        <span class="fright">${defaultItem}元</span>
                    </p>
